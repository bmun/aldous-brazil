...
export default function DelegateAccountsTab(props: DelegateAccountsTabProps = {}) {
    ...
    return (
        <div className="flex flex-col">
            {!hideHeader && (
                <>
                    <div className="flex flex-row items-center justify-center gap-4 px-4 py-3 bg-base-200 border-b border-base-300">
                        <button
                            type="button"
                        ...
                        <span className="text-base font-medium">
                            {delegates.length}/{MAX_DELEGATES_PER_SCHOOL} Delegates Created
                        </span>
                    </div>
                    {atLimit && (
