    ...
    return (
        <div className="h-full flex flex-col justify-start p-4">
            ...
            <div className="flex flex-col h-full">
                <div className="rounded-xl border-2 border-primary overflow-hidden bg-base-100 flex flex-col shadow-xl">
                    {!forceTab && (
                    ...
                    {currentView === "assignments" && (
                        <>
                            {!assignmentsUploaded ? (
                                <div className="flex flex-col bg-base-100 min-h-[750px] justify-center items-center text-3xl text-center p-4 gap-4 text-base-content h-full">
                                    <Image
