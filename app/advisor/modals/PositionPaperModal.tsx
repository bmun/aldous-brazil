...
function PositionPaperModal({
    ...
    return (
        <div className="fixed z-50 inset-0 w-full h-full flex flex-row items-center justify-center" style={{ animation: 'fadeIn 0.3s ease-out forwards' }}>
            ...
            <fieldset className="fieldset z-20 bg-base-100 border-2 border-primary w-full max-w-2xl max-h-[90vh] overflow-scroll rounded-box p-6 opacity-100 text-base-content shadow-xl" style={{ animation: 'fadeInScale 0.3s ease-out forwards' }}>
                <div className="mb-4">
