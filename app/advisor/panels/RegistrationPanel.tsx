            ...
            {registered && registration !== undefined ?
                <div className="flex flex-col w-full justify-start text-xl">
                    ...
                    <p>
                        ...
                        any questions to <span className="text-primary font-bold">brazilinfo@bmun.org</span> and <span className="text-primary font-bold">tech@bmun.org</span>. 
                    ...
                    <p>
                        ...
                        to <span className="text-primary font-bold">brazilinfo@bmun.org</span> and <span className="text-primary font-bold">tech@bmun.org</span>.
                    </p>
                    }
                ...
                <div className="flex flex-col w-full h-full justify-start">
                    <p className="text-xl">
                        ...
                        In order to change any information after submitting the form, an advisor will have to email <span className="font-bold text-primary">brazilinfo@bmun.org</span> and <span className="font-bold text-primary">tech@bmun.org</span>.
