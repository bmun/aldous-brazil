...
interface PositionPaperTabProps {
    /** When true, show the UI but disable interactions (used for individual advisor view). */
    disabled?: boolean;
}

function PositionPaperTab({ disabled = false }: PositionPaperTabProps) {
        ...
        <div className="flex flex-col gap-6 w-full">
            ...
            <div className={disabled ? "opacity-50 pointer-events-none" : ""}>
                <div className="grid grid-cols-2 gap-10">
                    <div className="card bg-base-100 shadow-md border-2 border-primary">
